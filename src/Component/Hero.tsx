  ...
  return (
    <div className="relative w-full">
      <div className="relative bg-yellow-50">
        <div className="container m-auto px-6 pt-32 md:px-12 lg:pt-[0.2rem] lg:pl-[4.75rem]">
          <div className="flex items-center flex-wrap px-2 md:px-0">
            <div className="relative px-5 lg:w-6/12 lg:py-24 xl:py-32">
